...
public class Mensaje {
    ...
    public static class Encoder implements javax.websocket.Encoder.Text<Mensaje> {
        @Override
    ...
    public static class Decoder implements javax.websocket.Decoder.Text<Mensaje> {
        @Override
